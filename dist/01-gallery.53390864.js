...
const renderGalleryItems = (pictures)=>pictures.reduce((acc, picture)=>acc + `<a class="gallery__item" href=${picture.original}>
...
insertGalleryItems(renderGalleryItems((0, _galleryItems.galleryItems)));
